      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="prose max-w-none">
          ...
          <section className="mb-8">
            ...
            <p>
              BorrowBase ("we", "us", "our") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our website and services. Please read this Privacy Policy carefully.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="mb-4">
              We collect information that you provide directly to us when you register for an account, create or modify your profile, set preferences, or make purchases through our platform. This information may include:
            </p>
            <ul className="list-disc pl-6 mb-4">
              <li>Personal information (name, email address, phone number)</li>
              <li>Profile information (username, password, profile picture)</li>
              <li>Payment information (processed securely by our payment providers)</li>
              <li>Rental information (item details, rental dates, locations)</li>
